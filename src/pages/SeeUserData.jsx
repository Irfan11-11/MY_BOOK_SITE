...
function SeeUserData({ setUserDiv, UserDiv, UserDivData }) {
    return (
        <>
            <div className={`${UserDiv} top-0 left-0 h-screen w-full backdrop-blur-sm opacity-80`}></div>{" "}
            <div className={`${UserDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
                <div className='bg-white text-black rounded p-4 w-[80%] md-:w-[50%] lg:w-[40%] card border shadow'>
